 ...
 */
public class ServerBluetoothService {
    // Debugging
    private static final String TAG = "ServerBluetoothService";
     ...
     */
    public ServerBluetoothService(Context context, Handler handler) {
    ...
    private void connectionLost() {
        ...
        ServerBluetoothService.this.start();
    }
...
class AcceptThread extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (socket != null) {
                synchronized (ServerBluetoothService.this) {
